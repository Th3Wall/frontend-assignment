...
The Pokèmons dataset is hardcoded inside the project.
...
You can add other libraries if needed; if you are not confident with some of these libraries you can pick alternatives.  
...
For the server you can start the app with `yarn workspace @frontend-assignment/server start`.
